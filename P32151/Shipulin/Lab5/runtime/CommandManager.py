...
from Labs.Lab5.runtime.ExitCommand import ExitCommand
from Labs.Lab5.runtime.HelpCommand import HelpCommand
from Labs.Lab5.runtime.Lab5Command import Lab5Command
...
class CommandManager(AnyManager):
    def __init__(self, iostream: MyInputOutputStream):
        ...
        self.add_command(Lab5Command(self))
