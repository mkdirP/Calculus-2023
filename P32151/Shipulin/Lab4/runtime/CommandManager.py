...
from Labs.Lab4.runtime.ExitCommand import ExitCommand
from Labs.Lab4.runtime.HelpCommand import HelpCommand
from Labs.Lab4.runtime.Lab4Command import Lab4Command
...
class CommandManager(AnyManager):
    def __init__(self, iostream: MyInputOutputStream):
        ...
        self.add_command(Lab4Command(self))
