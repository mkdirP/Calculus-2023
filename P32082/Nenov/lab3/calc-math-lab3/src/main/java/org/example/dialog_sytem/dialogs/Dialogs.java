...
import org.example.math.eq_solve.EqSolveMethod;
import org.example.math.eq_solve.HalfDivisionMethod;
import org.example.math.eq_solve.NewtonMethod;
import org.example.math.eq_solve.SimpleIterationMethod;
...
import org.example.math.systems.NewtonMethodForSystems;

import static org.example.math.eq_solve.Equations.*;
...
public class Dialogs {
    ...
    public static DialogElement solveEqSystem() {
        return new CustomDialog((context -> {
            ...
            int eqId = context.get("eq_id");
            NewtonMethodForSystems newtonMethodForSystems;
            switch (eqId) {
                case 1:
                    newtonMethodForSystems = new NewtonMethodForSystems(accuracy, system1);
                    break;
                case 2:
                    newtonMethodForSystems = new NewtonMethodForSystems(accuracy, system2);
                    break;
                default:
                    throw new DialogException();
            }
