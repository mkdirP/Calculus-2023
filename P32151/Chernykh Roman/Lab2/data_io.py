...
def get_interval(function):
    ...
    while True:
        try:
            ...
            print("Границы интервала должны быть числами, введёнными через пробел, и с расстоянием не больше одного.")
...
def ask_methods():
    ...
    while type != 1 and type != 2:
        try:
            type = int(input("Введите 1, чтобы выбрать метод хорд, 2 чтобы выбрать метод простой итерации: "))
        except ValueError:
            print("Введите 1 или 2")
    return type
